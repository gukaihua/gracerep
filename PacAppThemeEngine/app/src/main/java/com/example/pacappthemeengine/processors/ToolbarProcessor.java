...
import com.example.pacappthemeengine.ATEMenuPresenterCallback;
import com.example.pacappthemeengine.ATEOnMenuItemClickListener;
import com.example.pacappthemeengine.Config;
import com.example.pacappthemeengine.util.TintHelper;
...
public class ToolbarProcessor implements Processor<Toolbar, Menu> {
    ...
    public void process(@NonNull Context context, @Nullable String key, @Nullable Toolbar toolbar, @Nullable Menu menu) {
        ...
        boolean isLightMode;
        @Config.LightToolbarMode final int lightToolbarMode = Config.lightToolbarMode(context, key);
